...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run scene attribute inference on an image directory.")
    ...
    parser.add_argument("--prompt-file", default=str(ROOT_DIR / "configs" / "prompts" / "scene_attributes.txt"))
    ...
    from image_content.inference.scene import build_processor, load_prompt

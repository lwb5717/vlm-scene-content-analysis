...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run visual complexity inference on an image directory.")
    ...
    parser.add_argument("--prompt-file", default=str(ROOT_DIR / "configs" / "prompts" / "visual_complexity.txt"))
    ...
    from image_content.inference.complexity import build_processor, load_prompt
    ...
    written_rows = run_inference_task(
        ...
        progress_label="Complexity analysis",
    )
